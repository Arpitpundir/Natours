...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYXJwaXRwdW5kaXIiLCJhIjoiY2p5aHp3MnR2MDRybjNvbnJrYTh6NTB5bSJ9.n-89r1JdajXPvvktpQCxrA";
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/arpitpundir/cjyi061tw05vm1crveqe5h844',
...
var stripe = Stripe('pk_test_5dRMlo6cfTjNiRiK2YJQuK9t00p5G7qGfG'); //booktour btn has access to tourId now we will make a request to server for a stripe session
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/booking/checkout-sessions/".concat(tourId));
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, email, password) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  var password = document.getElementById('password').value; //const userPhoto = document.getElementById("photo").value;
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // The FormData interface provides a way to easily construct a set of key/value pairs representing form fields and their values, which can then be easily sent using the XMLHttpRequest.send() method. 
